...
**SSOT note (v0.1)**: DSH session todos are authoritative for in-flight work; long-state and plan mirror are **human-auditable** copies. v1.1 `@planrun/workflow` may unify gates.
